...
import { updateMap, updateMapData, addGeoJSONLayer } from '../../../components/mapview/map.js';
import { loadDetails, updateFeatureDetails } from '../../../components/details/details.js';
...
var buildRow = function(dataset, index) {
  var divContent = '<tr style="cursor:default;">';
